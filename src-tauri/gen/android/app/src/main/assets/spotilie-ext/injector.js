function R(){try{let Q={__cmpCall:function(){},__tcfapiCall:function(){},postMessage:function($){try{if($&&typeof $==="object"&&$.__cmpCall){let j=$.__cmpCall;window.postMessage({__cmpReturn:{returnValue:{eventStatus:"tcloaded",gdprApplies:!1},success:!0,callId:j?j.callId:null}},"*")}}catch(j){}}};Q.contentWindow=Q,Q.frames=Q,Q.__cmpLocator=Q,Q.__tcfapiLocator=Q;try{let $=Object.getOwnPropertyDescriptor(MessageEvent.prototype,"source");if($&&$.get){let j=$.get;Object.defineProperty(MessageEvent.prototype,"source",{get:function(){return j.call(this)||Q},configurable:!0})}}catch($){}try{if(!("__cmpCall"in Object.prototype))Object.defineProperty(Object.prototype,"__cmpCall",{get:function(){return Q.__cmpCall},configurable:!0});if(!("__tcfapiCall"in Object.prototype))Object.defineProperty(Object.prototype,"__tcfapiCall",{get:function(){return Q.__tcfapiCall},configurable:!0})}catch($){}let Y=[window,window.top,window.parent,globalThis];for(let $ of Y){if(!$)continue;try{$.__cmpLocator=Q,$.__tcfapiLocator=Q,$.__cmpCall=Q.__cmpCall}catch(j){}}try{let $=window.addEventListener;window.addEventListener=function(j,G,X){if(j==="message"&&typeof G==="function"){let J=function(V){try{if(V&&typeof V==="object"&&"source"in V)try{Object.defineProperty(V,"source",{get:()=>Q,configurable:!0})}catch(K){}return G.apply(this,arguments)}catch(K){if(K&&K.message&&(K.message.includes("__cmpCall")||K.message.includes("__cmp"))){console.warn("SpotiLIE: Suppressed CMP error in message listener:",K.message);return}throw K}};return $.call(this,j,J,X)}return $.call(this,j,G,X)}}catch($){}if(window.addEventListener("unhandledrejection",($)=>{let j=$.reason?.message||String($.reason||"");if(j.includes("__cmpCall")||j.includes("__cmp"))$.preventDefault()},!0),!window.__cmp){let $=function(){let j=Array.from(arguments);if(typeof j[2]==="function")try{j[2]({eventStatus:"tcloaded",gdprApplies:!1},!0)}catch(G){}};$.a=[],window.__cmp=$}if(!window.__tcfapi){let $=function(j,G,X){if(typeof X==="function")try{X({eventStatus:"tcloaded",gdprApplies:!1,tcString:"CP1234567890",listenerId:1},!0)}catch(J){}};$.a=[],window.__tcfapi=$}let Z=($)=>{try{let j=document.querySelector(`iframe[name="${$}"]`);if(!j){j=document.createElement("iframe"),j.name=$,j.id=$,j.style.display="none";let G=document.body||document.documentElement||document.head;if(G)G.appendChild(j)}if(j&&j.contentWindow)try{j.contentWindow.__cmpCall=Q.__cmpCall,j.contentWindow.__tcfapiCall=Q.__tcfapiCall}catch(G){}}catch(j){}};if(Z("__cmpLocator"),Z("__tcfapiLocator"),document.readyState==="loading")document.addEventListener("DOMContentLoaded",()=>{Z("__cmpLocator"),Z("__tcfapiLocator")});window.addEventListener("message",($)=>{try{if($.data&&typeof $.data==="object"&&$.data.__cmpCall){let j=$.data.__cmpCall;if($.source&&typeof $.source.postMessage==="function")$.source.postMessage({__cmpReturn:{returnValue:{eventStatus:"tcloaded",gdprApplies:!1},success:!0,callId:j?j.callId:null}},"*")}}catch(j){}},!0),window.addEventListener("error",($)=>{if($.message&&($.message.includes("__cmpCall")||$.message.includes("__cmp")))console.warn("SpotiLIE: Suppressed CMP TypeError:",$.message),$.stopImmediatePropagation(),$.preventDefault()},!0),console.log("SpotiLIE: CMP stub & locator iframes initialized")}catch(Q){console.error("SpotiLIE: Failed to initialize CMP stub",Q)}}var w=["/ad-logic/","spclient.wg.spotify.com/ads","spclient.wg.spotify.com/ad-logic","api.spotify.com/v1/ads","audio-ads.spotify.com","adeventtracker.spotify.com","ads-fa.spotify.com","adgen.spotify.com","ad-proxy.spotify.com","adstudio.spotify.com","ads.spotify.com","pixel.spotify.com","video-ak.cdn.spotify.com","adjust-callback.spotify.com","crashdump.spotify.com","datasharing.spotify.com","doubleclick.net","googleadservices.com","googletagservices.com","googlesyndication.com","google-analytics.com","pagead2.googlesyndication.com","securepubads.g.doubleclick.net","moatads.com","comscore.com","scorecardresearch.com","branch.io","branchster.link","app.link","facebook.com/tr","facebook.net/en_US/fbevents.js","connect.facebook.net","admob.com","adsrvr.org","adnxs.com","casalemedia.com","criteo.com","rubiconproject.com","openx.net","pubmatic.com","freewheel.tv","spotxchange.com","liveramp.com","rlcdn.com"],T=new RegExp(w.map((Q)=>Q.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|"),"i");function B(Q){return T.test(Q)}function S(Q){let Y=new Headers({"Access-Control-Allow-Origin":"*","Access-Control-Allow-Headers":"*","Access-Control-Allow-Methods":"*"});if(Q.includes(".js"))return Y.set("Content-Type","application/javascript"),new Response("",{status:200,headers:Y});return Y.set("Content-Type","application/json"),new Response("{}",{status:200,headers:Y})}function h(Q){if(!Q||typeof Q!=="object")return Q;if(Q.__spotilie_spoofed)return Q;try{Q.__spotilie_spoofed=!0}catch(Y){}if(Q.canPlayOnDemand!==void 0)Q.canPlayOnDemand=!0;if(Q.is_premium!==void 0)Q.is_premium=!0;if(Q.premium!==void 0&&typeof Q.premium==="boolean")Q.premium=!0;if(Q.product!==void 0&&typeof Q.product==="string"){if(Q.product==="free"||Q.product==="open")Q.product="premium"}if(Q.streaming_rules)Q.streaming_rules.advancement_disabled=!1,Q.streaming_rules.advancement_mode="NORMAL",Q.streaming_rules.skips_unlimited=!0,Q.streaming_rules.max_skips_per_hour=999;if(Q.skips_remaining!==void 0)Q.skips_remaining=999;if(Q.advancement)Q.advancement.advancement_mode="NORMAL",Q.advancement.advancement_disabled=!1,Q.advancement.skips_remaining=999;return Q}function L(){try{try{let J=Headers.prototype.set;Headers.prototype.set=function(K,F){if(K&&K.toLowerCase()==="x-cache-hint")return;return J.call(this,K,F)};let V=Headers.prototype.append;Headers.prototype.append=function(K,F){if(K&&K.toLowerCase()==="x-cache-hint")return;return V.call(this,K,F)}}catch(J){}let Q=JSON.parse;JSON.parse=function(J,V){try{let K=V?Q(J,V):Q(J);return h(K)}catch(K){try{return Q(J)}catch(F){return null}}};let Y=window.fetch;window.fetch=async function(J,V){let K=J,F=V,M=typeof K==="string"?K:K instanceof URL?K.toString():K.url;if(B(M))return S(M);try{if(K instanceof Request){if(K.headers.has("x-cache-hint")||K.headers.has("X-Cache-Hint")){let z=new Headers(K.headers);z.delete("x-cache-hint"),z.delete("X-Cache-Hint"),K=new Request(K,{headers:z})}}if(F&&F.headers){if(F.headers instanceof Headers)F.headers.delete("x-cache-hint"),F.headers.delete("X-Cache-Hint");else if(Array.isArray(F.headers))F.headers=F.headers.filter(([z])=>z.toLowerCase()!=="x-cache-hint");else if(typeof F.headers==="object")delete F.headers["x-cache-hint"],delete F.headers["X-Cache-Hint"]}}catch(z){}return Y.call(this,K,F)};let Z=XMLHttpRequest.prototype.open,$=XMLHttpRequest.prototype.send,j=XMLHttpRequest.prototype.setRequestHeader;XMLHttpRequest.prototype.setRequestHeader=function(J,V){if(J&&J.toLowerCase()==="x-cache-hint")return;return j.apply(this,arguments)},XMLHttpRequest.prototype.open=function(J,V){let K=V.toString();if(B(K))this.__blocked=!0;return Z.apply(this,arguments)};let G=navigator.sendBeacon;if(G)navigator.sendBeacon=function(J,V){if(B(J.toString()))return!0;return G.apply(this,arguments)};let X=window.Worker;if(X)window.Worker=function(J,V){let K=J.toString();if(K.startsWith("data:")||K.startsWith("blob:"))return new X(J,V);try{let F=`
  ...
  `}function v(){let Q=document.querySelector('meta[name="viewport"]');if(!Q)Q=document.createElement("meta"),Q.name="viewport",(document.head||document.documentElement).appendChild(Q);Q.content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover"}function u(){let Q=()=>{try{document.documentElement.style.setProperty("--app-nav-h","52px"),document.documentElement.style.setProperty("--player-h","148px"),document.documentElement.style.setProperty("--top-bar-h","56px")}catch(Y){}};Q(),window.visualViewport?.addEventListener("resize",Q),window.addEventListener("resize",Q)}function k(){let Q=globalThis.browser||globalThis.chrome;if(!Q?.runtime?.onMessage)return;Q.runtime.onMessage.addListener((Y)=>{if(Y?.type==="SET_NAV_HEIGHT"&&typeof Y.height==="number"){let Z=Math.max(0,Y.height);document.documentElement.style.setProperty("--sys-nav-h",`${Z}px`),document.documentElement.style.setProperty("--bottom-h",`${Z+52+148+6}px`);let $=document.getElementById("spotilie-bottom-nav");if($)$.style.setProperty("bottom",`calc(${Z}px + 6px)`,"important");console.log(`SpotiLIE: Nav height set to ${Z}px CSS from Kotlin`)}})}function W(Q){let Y=`a[href="${Q}"]`;if(Q==="/collection")Y='a[href^="/collection"], a[href="/collection/playlists"], a[href="/library"]';let Z=document.querySelector(Y);if(Z){Z.click();return}try{history.pushState(null,"",Q),window.dispatchEvent(new PopStateEvent("popstate"))}catch($){window.location.href=Q}}function g(){let Q=()=>{if(document.getElementById("spotilie-bottom-nav"))return;let Y=document.createElement("div");Y.id="spotilie-bottom-nav",Y.innerHTML=`
    ...
    `,Y.querySelectorAll(".nav-item").forEach((G)=>{G.addEventListener("click",()=>{let X=G.getAttribute("data-nav");if(X==="home")W("/");else if(X==="search")W("/search");else if(X==="library")W("/collection")})}),document.body.appendChild(Y);let Z=()=>{let G=window.location.pathname;Y.querySelectorAll(".nav-item").forEach((X)=>{X.classList.remove("active");let J=X.getAttribute("data-nav");if(J==="home"&&(G==="/"||G===""))X.classList.add("active");else if(J==="search"&&G.startsWith("/search"))X.classList.add("active");else if(J==="library"&&G.startsWith("/collection"))X.classList.add("active")})},$=history.pushState;history.pushState=function(){$.apply(this,arguments),Z()};let j=history.replaceState;history.replaceState=function(){j.apply(this,arguments),Z()},window.addEventListener("popstate",Z),Z()};if(document.body)Q();else{let Y=setInterval(()=>{if(document.body)clearInterval(Y),Q()},50)}}function m(){let Q=[".playback-bar",'[data-testid="playback-progressbar"]','[data-testid="progress-bar"]','[class*="progressBar"]','[class*="PlaybackBar"]','[class*="playback-bar"]','div[role="slider"]'],Y=()=>{for(let Z of Q)document.querySelectorAll(Z).forEach(($)=>{let j=$;j.style.setProperty("display","flex","important"),j.style.setProperty("visibility","visible","important"),j.style.setProperty("opacity","1","important"),j.style.setProperty("overflow","visible","important"),j.style.setProperty("min-width","120px","important"),j.style.setProperty("width","100%","important");let G=j.parentElement,X=0;while(G&&X<8){let J=getComputedStyle(G);if(J.overflow==="hidden"||J.overflowY==="hidden")G.style.setProperty("overflow","visible","important");if(J.display==="none")G.style.setProperty("display","flex","important");G=G.parentElement,X++}})};setTimeout(Y,500),setTimeout(Y,1500),setTimeout(Y,3000),setInterval(Y,5000)}function I(){l(),p(),d(),o(),s(),c(),n()}function p(){try{let Q=HTMLMediaElement.prototype.play;if(Q&&!Q._spotilie_patched){let Y=function(){return console.log("SpotiLIE: HTMLMediaElement.play() invoked on",this.src||this.currentSrc||"MSE stream"),Q.apply(this,arguments).then((Z)=>{return console.log("SpotiLIE: HTMLMediaElement.play() SUCCEEDED"),Z}).catch((Z)=>{throw console.error("SpotiLIE: HTMLMediaElement.play() REJECTED:",Z?.name,Z?.message,Z),Z})};Y._spotilie_patched=!0,HTMLMediaElement.prototype.play=Y}document.addEventListener("error",(Y)=>{let Z=Y.target;if(Z&&(Z.tagName==="AUDIO"||Z.tagName==="VIDEO")){let $=Z.error;console.error("SpotiLIE: Media Element Error Event:",$?.code,$?.message,Z.src)}},!0)}catch(Q){}}function l(){document.addEventListener("click",(Q)=>{let Y=Q.target;if(Y){let Z=`${Y.tagName}.${(Y.className||"").toString().slice(0,40)} [id=${Y.id||""}] [data-testid=${Y.getAttribute("data-testid")||""}]`;console.log("SpotiLIE Click Target:",Z)}},!0)}function c(){document.addEventListener("click",(Q)=>{if(!Q.isTrusted)return;let Y=Q.target;if(!Y)return;if(Y.closest('button, a[href*="/artist/"], a[href*="/album/"], [role="button"], [data-testid="more-button"], [data-testid="add-button"]'))return;let Z=Y.closest('[data-testid="tracklist-row"], [role="row"]');if(!Z)return;let $=Z.querySelector('button[aria-label*="Play" i], button[aria-label*="play" i], [data-testid="play-button"], [data-testid="row-play-button"], [data-encore-id="buttonPrimary"], [class*="playButton" i]');if(!$)$=Array.from(Z.querySelectorAll("button")).find((X)=>{let J=(X.getAttribute("aria-label")||X.getAttribute("data-testid")||X.className||"").toLowerCase();return J.includes("play")||J.includes("reproducir")})||null;if($){console.log("SpotiLIE: Track play button clicked via row tap"),$.click();return}let j=Z.querySelector('a[data-testid="internal-track-link"], a[href*="/track/"]');if(j)console.log("SpotiLIE: Clicking internal track link via row tap"),j.click()},!1)}function x(Q){for(let Y of Q){let Z=document.querySelector(Y);if(Z)try{return Z.click(),console.log(`SpotiLIE: Clicked media button via selector: ${Y}`),!0}catch($){console.warn(`SpotiLIE: Failed clicking ${Y}:`,$)}}return!1}function d(){window.spotilieMediaAction=(Q)=>{console.log(`SpotiLIE: spotilieMediaAction executed for action '${Q}'`);let Y=document.querySelector("audio, video");if(Q==="play"){if(!x(['button[data-testid="control-button-playpause"]','button[aria-label*="Play" i]','button[aria-label*="reproducir" i]'])||Y&&Y.paused)Y?.play().catch(()=>{})}else if(Q==="pause"){if(x(['button[data-testid="control-button-playpause"]','button[aria-label*="Pause" i]']),Y&&!Y.paused)Y.pause()}else if(Q==="toggle"){if(!x(['button[data-testid="control-button-playpause"]'])&&Y)if(Y.paused)Y.play().catch(()=>{});else Y.pause()}else if(Q==="next")x(['button[data-testid="control-button-skip-forward"]','button[aria-label*="Next" i]','button[aria-label*="Siguiente" i]','[data-testid="skip-ad-button"]']);else if(Q==="prev")x(['button[data-testid="control-button-skip-back"]','button[aria-label*="Previous" i]','button[aria-label*="Anterior" i]'])}}function s(){try{if(!navigator.mediaDevices?.addEventListener)return;navigator.mediaDevices.addEventListener("devicechange",()=>{setTimeout(()=>{let Q=document.querySelector("audio, video");if(Q&&!Q.paused)console.log("SpotiLIE: Audio output device changed/disconnected — pausing playback"),Q.pause(),x(['button[data-testid="control-button-playpause"]'])},250)})}catch(Q){console.warn("SpotiLIE: Could not set up Bluetooth pause guard",Q)}}function o(){try{let Q=globalThis.browser||globalThis.chrome;if(!Q?.runtime?.onMessage)return;Q.runtime.onMessage.addListener((Y)=>{if(Y?.type==="MEDIA_ACTION"&&typeof Y.action==="string")return console.log("SpotiLIE: MEDIA_ACTION received from native bridge:",Y.action),window.spotilieMediaAction?.(Y.action),!0}),console.log("SpotiLIE: Native message listener active")}catch(Q){console.warn("SpotiLIE: Could not set up native message listener",Q)}}function n(){}function C(){let Q={title:"",artist:"",isPlaying:!1},Y=null,Z=!1,$=!1,j=()=>{let z=document.title||"",D=z.indexOf(" - ");if(D<1)return null;let _=z.substring(0,D).trim(),H=z.substring(D+3).trim(),N=H.lastIndexOf(" · ");if(N>0)H=H.substring(0,N).trim();if(!_||_.toLowerCase()==="spotify")return null;return{title:_,artist:H,isPlaying:X()}},G=()=>{try{let z=document.querySelector('[data-testid="context-item-info-title"]')||document.querySelector('[data-testid="now-playing-widget"] [data-testid="context-item-link"]'),D=document.querySelector('[data-testid="context-item-info-subtitles"]')||document.querySelector('[data-testid="now-playing-widget"] [data-testid="context-item-info-subtitles"]');if(!z||!D)return null;let _=(z.textContent||"").trim(),H=(D.textContent||"").trim();if(!_||_.toLowerCase()==="advertisement")return null;return{title:_,artist:H,isPlaying:X()}}catch(z){return null}},X=()=>{let z=document.querySelector('button[data-testid="control-button-playpause"]');if(z)return(z.getAttribute("aria-label")||"").toLowerCase()==="pause";return!!document.querySelector('button[aria-label="Pause"]')},J=(z)=>{if(!z.title)return;if(z.title===Q.title&&z.artist===Q.artist&&z.isPlaying===Q.isPlaying)return;Q={...z};try{let D=globalThis.browser||globalThis.chrome;if(D?.runtime?.sendMessage){D.runtime.sendMessage({type:"UPDATE_METADATA",title:z.title,artist:z.artist,isPlaying:z.isPlaying}).catch(()=>{}),console.log(`SpotiLIE: Metadata sent → "${z.title}" by "${z.artist}" playing=${z.isPlaying}`);return}}catch(D){}try{let D=window.__TAURI__?.core?.invoke||window.__TAURI_INTERNALS__?.invoke;if(D)D("update_media_info",{title:z.title,artist:z.artist,isPlaying:z.isPlaying})}catch(D){}},V=()=>{if(Y)clearTimeout(Y);Y=setTimeout(()=>{let z=j()||G();if(z)J(z)},250)},K=()=>{if(Z)return;let z=document.querySelector("title");if(!z)return;Z=!0,new MutationObserver(V).observe(z,{subtree:!0,characterData:!0,childList:!0})},F=()=>{if($)return;let z=document.querySelector('[data-testid="now-playing-bar"]')||document.querySelector(".Root__now-playing-bar");if(!z)return;$=!0,new MutationObserver(V).observe(z,{subtree:!0,characterData:!0,childList:!0,attributes:!0,attributeFilter:["aria-label"]})};setInterval(V,2000),document.addEventListener("play",(z)=>{if(z.target?.tagName==="AUDIO")V()},!0),document.addEventListener("pause",(z)=>{if(z.target?.tagName==="AUDIO")V()},!0);let M=()=>{K(),F()};if(document.readyState==="loading")document.addEventListener("DOMContentLoaded",M);else M();if(document.body){let z=new MutationObserver(()=>{if(!$)F();if(!Z)K();if($&&Z)z.disconnect()});z.observe(document.body,{childList:!0,subtree:!1})}}function P(){try{i(),r(),a(),console.log("SpotiLIE: Premium features module active")}catch(Q){console.error("SpotiLIE: Premium features init failed",Q)}}function i(){let Q=Response.prototype.json;Response.prototype.json=async function(){let Y=await Q.call(this);if(!Y||typeof Y!=="object")return Y;if(Y.skips_remaining!==void 0)Y.skips_remaining=999;if(Y.advancement)Y.advancement.advancement_mode="NORMAL",Y.advancement.advancement_disabled=!1;if(Y.enableLyrics!==void 0)Y.enableLyrics=!0;if(Y.canShowLyrics!==void 0)Y.canShowLyrics=!0;if(Y.lyricsEnabled!==void 0)Y.lyricsEnabled=!0;if(Y.features){if(Y.features.enableLyrics!==void 0)Y.features.enableLyrics=!0;if(Y.features.lyrics!==void 0)Y.features.lyrics=!0}return Y}}function r(){try{let Q=localStorage.getItem("playback.settings");if(Q)try{let Y=JSON.parse(Q),Z=!1;if(!Y.autoplay)Y.autoplay=!0,Z=!0;if(Y.crossfade===void 0)Y.crossfade=0,Z=!0;if(Z)localStorage.setItem("playback.settings",JSON.stringify(Y))}catch(Y){}}catch(Q){}}function a(){setInterval(()=>{let Y=document.querySelector('[data-testid="connect-device-picker-button"]');if(Y)Y.style.removeProperty("display"),Y.style.removeProperty("visibility"),Y.style.removeProperty("opacity")},5000)}(function(){if(window._spotilie_initialized)return;window._spotilie_initialized=!0,console.log("SpotiLIE: Injector Active v2.0 (Nuclear Edition)"),L(),R(),q(),P(),E(),I(),C()})();
